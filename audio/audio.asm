...
SONIDO1						; Sonido para codificación RZ
	CLRF 		TMR0
	MOVLW		B'10100000'	; Habilito interrupcion por TMR0 y las globales
	MOVWF		INTCON	
	BANKSEL		PORTA
...
INICIALIZACION	      
	...
	MOVWF		TEMPO
	MOVLW		.10
	MOVWF		TEMPO2		; Configuracion de retardo para conseguir buena apreciacion
LOOP
	GOTO 	SONIDO1
